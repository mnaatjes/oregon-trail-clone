...
*   **\`models.py\`:** Anemic DTOs (\`DomainRoot\`, \`DomainRecord\`, or \`DomainSpore\`).
...
graph TD
    ...
    Spore --> S_Model[models.py: Inherit DomainSpore]
...
- [x] Implement \`DomainSpore\` base contract with Identity Purity Guards.
